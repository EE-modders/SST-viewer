deb:
	...
	mkdir -p linux_packaging/deb/usr/share/applications
	...
	cp linux_packaging/SST-viewer.desktop linux_packaging/deb/usr/share/applications
	...
	rm -rf linux_packaging/deb/usr/lib/SSTviewer/lib/.github
